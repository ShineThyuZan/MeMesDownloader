...
import com.tpo.cocktailrecipe.viewHolder.IngredientViewHolder
import java.util.*
...
class IngredientAdapter() : RecyclerView.Adapter<IngredientViewHolder>(), Parcelable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IngredientViewHolder {
        ...
        val view = inflater.inflate(com.tpo.cocktailrecipe.R.layout.viewholder_ingredient, parent, false)
